...
const levelOptionList = [
  { title: "0점 (본인 평가 실력과 완전 달라요)", score: 0 },
  { title: "5점 (본인 평가 실력보다 조금 떨어져요)", score: 5 },
  { title: "10점 (본인 평가 실력과 같아요)", score: 10 }
];
...
export default function PlayerScoring({ title, collection, dataId }: Props) {
